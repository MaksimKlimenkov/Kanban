...
public class TeamMemberController : ControllerBase
{
    ...
    public TeamMemberController(IRepository<TeamMember> teamMemberRepository, UserManager<User> userManager, IMapper mapper)
    {
    ...
    public async Task<IActionResult> MemberInfo([FromQuery] string userId, [FromQuery] int teamId)
    {
        ...
        var currentMember = await _teamMemberRepository.Query.FindByUser(currentUserId!).FindByTeam(teamId).FirstOrDefaultAsync();
