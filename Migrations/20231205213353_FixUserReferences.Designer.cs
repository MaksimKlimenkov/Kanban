...
namespace Kanban.Migrations
{
    ...
    [Migration("20231205213353_FixUserReferences")]
    partial class FixUserReferences
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kanban.Models.TaskComment", b =>
                {
                    ...
                    b.Property<string>("TeamMemberUserId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("TeamMemberUserId", "TeamMemberTeamId");
            ...
            modelBuilder.Entity("Kanban.Models.TaskComment", b =>
                {
                    ...
                    b.HasOne("Kanban.Models.TeamMember", "TeamMember")
                        .WithMany()
                        .HasForeignKey("TeamMemberUserId", "TeamMemberTeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
